        ...
        <div>
          ...
          <Navbar bg={BG} variant={VARIANT} style={{ boxShadow: '0px 2px 5px #000000'}}>
			...
			<Container>
				...
				<Route path="/course/:courseID/exercise/:exerciseID/edit" render={(props) => this.requireAuth(["admin", "maintainer"], <ExerciseView {...props} mode={"edit"} />)} />
				<Route path="/course/:courseID/exercise/:exerciseID/solve" render={(props) => this.requireAuth([], <ExerciseView {...props} mode={"solve"} />)} />
			</Container>
        </div>
    </Router>
    );
